...
export default function StudentsShow({
    ...
    const submitNote = (event) => {
        ...
        noteForm.post("/students/notes", {
            preserveScroll: true,
            onSuccess: () =>
                noteForm.reset("title", "note", "category", "follow_up_date"),
        });
    };
    ...
    const submitTimeline = (event) => {
        ...
        timelineForm.post("/students/timeline", {
            preserveScroll: true,
            onSuccess: () =>
                timelineForm.reset("title", "description", "event_type"),
        });
    };
                    ...
                    <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        >
                            ...
                            <input
                                ...
                                value={timelineForm.data.event_type}
                                onChange={(event) =>
                                    timelineForm.setData(
                                        "event_type",
                                        event.target.value,
                ...
                <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                Published and draft results recorded for this
                                student.
                            </p>
                        </div>
                    </div>
