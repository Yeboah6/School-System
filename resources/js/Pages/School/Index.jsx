...
export default function SchoolIndex({
    ...
    const handleAcademicYearSubmit = (e) => {
        ...
        if (academicYearForm.data.id) {
            router.put(
                `/school/academic-years/${academicYearForm.data.id}`,
                academicYearForm.data,
                {
                    preserveScroll: true,
    ...
    const handleDepartmentSubmit = (e) => {
        ...
        if (departmentForm.data.id) {
            router.put(
                `/school/departments/${departmentForm.data.id}`,
                departmentForm.data,
                {
                    preserveScroll: true,
    ...
    const handleSubjectSubmit = (e) => {
        ...
        if (subjectForm.data.id) {
            router.put(
                `/school/subjects/${subjectForm.data.id}`,
                subjectForm.data,
                {
                    preserveScroll: true,
    ...
    const handleBranchSubmit = (e) => {
        ...
        if (branchForm.data.id) {
            router.put(
                `/school/branches/${branchForm.data.id}`,
                branchForm.data,
                { preserveScroll: true, onSuccess: () => branchForm.reset() },
            );
            return;
        }
        branchForm.post("/school/branches", {
            preserveScroll: true,
            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    {stats.map((stat) => (
                        ...
                        >
                            <div
                                className={`mb-3 inline-flex h-11 w-11 items-center justify-center rounded-xl ${statColorMap[stat.tone] || "bg-slate-100 text-slate-700"}`}
                            >
                                {stat.value}
                            </div>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <label className="block text-sm font-medium text-slate-700">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-slate-900 outline-none transition focus:border-slate-400 focus:bg-white"
                                    />
                                </label>
                                <label className="block text-sm font-medium text-slate-700">
                                    School type
                        ...
                        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            >
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    <input
                                        type="date"
                                        value={academicYearForm.data.starts_at}
                                        onChange={(e) =>
                                            academicYearForm.setData(
                                                "starts_at",
                                                e.target.value,
                                    ...
                                    <input
                                        type="date"
                                        value={academicYearForm.data.ends_at}
                                        onChange={(e) =>
                                            academicYearForm.setData(
                                                "ends_at",
                                                e.target.value,
                                ...
                                <label className="flex items-center gap-2 text-sm text-slate-700">
                                    <input
                                        type="checkbox"
                                        checked={
                                            academicYearForm.data.is_current
                                        }
                                        onChange={(e) =>
                                            academicYearForm.setData(
                                                "is_current",
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Branches are available when assigning classes and
                            students.
                        </p>
                                    ...
                                    >
                                        <div className="flex items-center justify-between gap-2">
                                            <div>
                                                ...
                                                <span className="ml-2 rounded-full bg-indigo-100 px-2 py-1 text-[10px] font-semibold text-indigo-700">
                                                    {branch.code}
                                                </span>
                                            </div>
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() =>
                                                        deleteEntity(
                                                            `/school/branches/${branch.id}`,
                                                        )
                                                    }
                                                    className="rounded-lg border border-rose-200 bg-rose-50 px-2 py-1 text-[10px] font-semibold text-rose-700"
                                                >
                                                    Delete
                                                </button>
                                            </div>
                    ...
                    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="mt-4 space-y-2">
                            {classes?.length ? (
                                ...
                                <p className="text-sm text-slate-500">
                                    Create a class after adding a branch.
                                </p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            {terms && terms.length > 0 ? (
                                terms.map((term) => (
                                    ...
                                    >
                                        ...
                                        {term.is_current && (
                                            <div className="mt-2 inline-flex rounded-full bg-emerald-100 px-2 py-1 text-[10px] font-semibold text-emerald-700">
                                                Current
                                            </div>
                                        )}
                        ...
                        >
                            <input
                                ...
                                onChange={(e) =>
                                    termForm.setData("name", e.target.value)
                                }
                                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-slate-900"
                            />
                            <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() =>
                                                        deleteEntity(
                                                            `/school/departments/${department.id}`,
                                                        )
                                                    }
                                                    className="rounded-lg border border-rose-200 bg-rose-50 px-2 py-1 text-[10px] font-semibold text-rose-700"
                                                >
                        ...
                        >
                            ...
                            <input
                                ...
                                value={departmentForm.data.head_name}
                                onChange={(e) =>
                                    departmentForm.setData(
                                        "head_name",
                                        e.target.value,
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        >
                            ...
                            />
                            <input
                                placeholder="Level (e.g. JHS / SHS)"
                                value={classForm.data.level}
                                onChange={(e) =>
                                    classForm.setData("level", e.target.value)
                                }
                                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-slate-900"
                            />
                            <select
